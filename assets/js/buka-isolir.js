// ==========================================================================
// 1. GENERATE PREVIEW SURAT BUKA ISOLIR (ISI DIBIARKAN UTUH KHAS ISOLIR)
// ==========================================================================
function generatePreview(event) {
    ...
    try {
        ...
        // Keterangan & Penanggung Jawab Khas Buka Isolir
        ...
        // Data Penerima Kuasa
        const elAlamatKuasa = document.getElementById('alamatKuasa');
        const alamatKuasaVal = (elAlamatKuasa && elAlamatKuasa.value.trim() !== '') ? elAlamatKuasa.value.trim() : '';
        ...
        // Pengaturan Kondisional Blok Kuasa (Sembunyi Otomatis Jika Kosong)
        ...
        if (blockKuasa) {
            if (!namaKuasa) {
                ...
                setText('prevKuasaAlamat', alamatKuasaVal);
...
// ==========================================================================
// 2. DOWNLOAD PDF (PERBAIKAN MARGIN ATAS 18MM & TTD UTUH PAS 1 HALAMAN A4)
// ==========================================================================
async function downloadPDF() {
    ...
    // --- STYLE INJECTION: MARGIN ATAS 18MM & PRESISI PAS 1 HALAMAN ---
