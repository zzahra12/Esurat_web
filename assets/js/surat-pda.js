function generatePreview(event) {
    ...
    try {
        ...
        // 2. Ambil Input Alamat & Detail PDA
        ...
        const isTtdChecked = document.getElementById('checkTtdTelkom')?.checked;
        ...
        const imgTtd = document.getElementById('imgTtdTelkom');
        if (imgTtd) {
