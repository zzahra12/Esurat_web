// ==========================================================================
// 1. GENERATE PREVIEW SURAT ISOLIR (DURASI & TANGGAL KHAS ISOLIR UTUH)
// ==========================================================================
function generatePreview(event) {
    ...
    try {
        ...
        // Data Detail Isolir Khas Isolir
        const durasiIsolir = getValue('durasiIsolir', '-');
        const tglIsolirInput = getValue('tglIsolir');
        const tglBukaIsolirInput = getValue('tglBukaIsolir');
        const keteranganIsolir = getValue('keteranganIsolir', '-');
        ...
        setText('prevDurasiIsolir', durasiIsolir);
        setText('prevTglIsolir', tglIsolirFormatted);
        setText('prevTglBukaIsolir', tglBukaIsolirFormatted);
        setText('prevKeteranganIsolir', keteranganIsolir);
...
// ==========================================================================
// 2. DOWNLOAD PDF (SURAT ISOLIR - MARGIN ATAS 18MM & PRESISI 1 HALAMAN)
// ==========================================================================
async function downloadPDF() {
    ...
    // --- STYLE INJECTION: MARGIN ATAS 18MM & SPASI KONSISTEN ISOLIR ---
